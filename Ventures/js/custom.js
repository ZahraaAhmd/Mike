...
$(document).ready(function() {
    ...
    //     $("#step2").show();
    // });
    $("#register-form,form.appoitment").submit(function(e) {
        e.preventDefault();
    });
    ...
    if ($(window).width() > 992) {
        $(window).scroll(function() {
            ...
            if (windscroll > 0) {
                ...
                $('.doctor-info-row.active .doctor-card .main-info .doctor-rate h3 .inner-head').each(function() {
                    var html = $(this).html();
                    var word = html.substr(0, html.indexOf(" "));
                    var rest = html.substr(html.indexOf(" "));
                    $(".doctor-info .doctor-calander h4").html(word + '’s availability');
    ...
    $(".block-collapsed-btn").click(function() {
        ...
        /* $(".doctor-info-row.collapsed-block .doctor-calander").hide();
        $(".doctor-info-row.active .doctor-calander").show(); */
    });
    ...
    $(".doctor-info .doctor-calander .calandar-div .cal-time:not(.empty-cal) span").click(function() {
        $(".doctor-info .doctor-calander .calandar-div .cal-time span").removeClass('active');
        $(this).addClass('active');
    });
});
